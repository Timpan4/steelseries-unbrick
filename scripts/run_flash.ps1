...
$log = "C:\Users\timpa\Desktop\steelseries_firmware_backup\usb_only_work\flash_run.log"
...
wsl -d Debian -u root -- python3 /mnt/c/Users/timpa/Desktop/steelseries_firmware_backup/usb_only_work/wsl_flash_rx.py 2>&1 | ForEach-Object { Log "wsl: $_" }
Log "=== END ==="
